...
module UC_MB_retry_transmitting_rules_v2_tb;
  ...
  UC_MB_retry_transmitter_rules_v2 dut (
      .clk(clk),
      .rst_n(rst_n),
      .init(init),
      ...
      .i_clear_flit_replay_num(i_clear_flit_replay_num),
