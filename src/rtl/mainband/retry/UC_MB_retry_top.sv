...
module UC_MB_retry_top (
  ...
  logic                  nak_scheduled;
  nak_schedule_type_t    nak_scheduled_type;
  logic                  start_replay;
  ...
  logic [7:0] tx_replay_flit_seq_num_u1;
  logic [7:0] tx_replay_flit_seq_num_u2;
  ...
  // 1. implicit_rx_rules
  // =========================================================================
  UC_MB_retry_implicit_rx_rules u_implicit_rx_rules (
      .clk                       (clk),
      .rst_n                     (rst_n),
      .init                      (init),
  ...
  // 2. ack_nak_discard_rules
  // =========================================================================
  UC_MB_retry_receiver_rules u_receiver_rules (
      .clk                       (clk),
      .rst_n                     (rst_n),
      .init                      (init),
  ...
  // 3. ack_nak_processing
  // =========================================================================
  UC_MB_retry_ack_nak_processing u_ack_nak_processing (
      .clk                      (clk),
      .rst_n                    (rst_n),
      .init                     (init),
      .i_rx_replay_command      (rx_replay_command),
  ...
  // 4. replay_schedule
  // =========================================================================
  UC_MB_retry_replay_schedule u_replay_schedule (
      .clk                        (clk),
      .rst_n                      (rst_n),
      .init                       (init),
      .i_tx_phase                 (tx_phase),
      ...
      .i_tx_replay_flit_seq_num   (tx_replay_flit_seq_num_u1),
      .o_tx_replay_flit_seq_num   (tx_replay_flit_seq_num_u2),
  ...
  // 7. snh_condition_checker
  // =========================================================================
  UC_MB_retry_snh_condition_checker u_snh_condition_checker (
      .clk                     (clk),
      .rst_n                   (rst_n),
      .init                    (init),
      .i_tx_phase              (tx_phase),
