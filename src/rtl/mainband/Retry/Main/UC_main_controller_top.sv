...
module main_controller_top (
    ...
    output logic                    o_log_cie,                   // log correctable internal error (schedule)
    ...
    output logic                    o_log_cie,                   // log correctable internal error (transmit)
    output logic [7:0]              o_nak_ignore_flit_seq_num    // nak ignore flit sequence number
    output logic [7:0]              o_ackd_flit_seq_num          // ackd flit sequence number
    output logic [7:0]              o_tx_replay_flit_seq_num     // tx replay flit sequence number  
    ...
    valid_ack_nak_processing u_valid_ack_nak_processing (
        ...
        .o_tx_replay_flit_seq_num (o_tx_replay_flit_seq_num),
        .o_nak_ignore_flit_seq_num(o_nak_ignore_flit_seq_num),
    ...
    replay_schedule u_replay_schedule (
        ...
        .o_tx_replay_flit_seq_num  (o_tx_replay_flit_seq_num),
        .o_nak_ignore_flit_seq_num (w_nak_ignore_flit_seq_num_rs),
        ...
        .o_start_buffer_replay_mode(i_start_buffer_replay_mode)
    );
    ...
    buffer u_buffer (
        ...
        .rst_n                    (rst_n),
        .init                     (init),
        .i_tx_replay_flit_seq_num (o_tx_replay_flit_seq_num),
        .i_ackd_flit_seq_num      (o_ackd_flit_seq_num),
