// ================================================================================================================================
//  FILENAME    : UC_sb_rx_top_EP.sv
//  MODULE      : UC_sb_rx_top_EP
...
// ================================================================================================================================ 
  import UC_sb_rx_pkg::*;
   ...
   import UC_sb_rx_pkg_EP::*; 
    ...
    ------------------------------------------*/
    output logic [127:0]      o_remote_req_pkt,     // Full request packet forwarded directly from Decoder (EP only)
    output logic              o_remote_req_vld,     // Valid indicator for remote request (EP only)
...
// ======================================================================= //
    ...
    logic           s_decoder_request_parity_err;  // Request parity error    (from Decoder, EP only)
...
// ======================================================================= //
    ...
    UC_rx_controller_decoder_EP #(.NC(NC)) u_decoder (
        .i_clk              (i_clk),
        .i_rstn             (i_rst_n),
        .i_init_n           (i_init_n),
        // RDI Interface
        ...
        // EP-only: request packets go directly to Remote Die Controller 
        .o_remote_req_pkt   (o_remote_req_pkt),
        .o_remote_req_vld   (o_remote_req_vld),
        .o_req_parity_err   (s_decoder_request_parity_err)
    );
...
// ======================================================================= //
    ...
    UC_rx_msgs_ctrl_EP #(.NC(NC)) u_msgs_ctrl (
        .i_clk                (i_clk),
        .i_rstn               (i_rst_n),
        .i_init_n             (i_init_n),
...
// ======================================================================= //
    ...
    assign o_sb_rx_parity_error = s_comp_ctrl_parity_error | s_msg_ctrl_parity_error | s_decoder_request_parity_err ;
