// =================================================================================================
//  FILENAME    : tx_rdi_controller_EP.sv
//  MODULE      : tx_rdi_controller_EP
...
module tx_rdi_controller_EP #(
 ...
 always_comb begin
    ...
    TX_STATE_IDLE: begin
        ...
        else if ((i_remote_valid && ~i_stall_tx) || (i_remote_valid && i_remote_comp)) begin
            r_next_state   = TX_STATE_SEND;
    ...
    // ========================================================
     TX_STATE_SEND : begin
        ...
        if((s_phase_last_flag && r_pkt_length) || (s_phase_half_flag && !r_pkt_length)) begin
            ...
            end else if ((i_remote_valid && ~i_stall_tx) || (i_remote_valid && i_remote_comp)) begin
                r_next_state = TX_STATE_SEND ;
                s_pkt_tx = i_remote_pkt ;
                s_pkt_length = i_remote_length ;
                s_pkt_reg_vld = 1 ;
