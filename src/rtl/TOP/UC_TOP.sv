...
// ALSM
logic w_link_status, w_ce_adapter_transition_retrain, w_ALSM_start_param_exch, w_linkerror, w_start_retrain;
...
logic w_sb_config_req           , w_sb_32_B                 , w_sb_invalid_param_exch , w_sb_local_timeout,
      ...
      w_sb_remote_timeout       , w_sb_fdi_overflow         , w_sb_rdi_overflow       ,
      w_i_sb_mailbox_data_vld   , w_i_sb_mailbox_trigger_en , w_sb_Header_log1_valid  ,
      w_sb_adapter_advcap_valid , w_sb_cxl_advcap_valid     ;
...
UC_regfile  UC_regfile_inst (
    ...
    .i_sb_mailbox_data_vld          (w_i_sb_mailbox_data_vld),
