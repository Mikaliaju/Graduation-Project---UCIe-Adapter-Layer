  ...
  function automatic fdi_dec_t fdi_decode_opcode(input logic [4:0] op);
    ...
    unique case (op)
      FDI_OP_MEM_RD_32, FDI_OP_CFG_RD_32: begin
        ...
        d.is_read           = 1'b1;
        d.data_bits         = 7'd0;
        d.completion_opcode = FDI_OP_COMP_32_DATA;
        d.is_conf           = (op == FDI_OP_CFG_RD_32);
      end
      ...
      FDI_OP_MEM_RD_64, FDI_OP_CFG_RD_64: begin
        ...
        d.is_read           = 1'b1;
        d.data_bits         = 7'd0;
        d.completion_opcode = FDI_OP_COMP_64_DATA;
        d.is_conf           = (op == FDI_OP_CFG_RD_64);
      end
      ...
      FDI_OP_MEM_WR_32, FDI_OP_CFG_WR_32: begin
        ...
        d.is_read           = 1'b0;
        d.data_bits         = 7'd32;
        d.completion_opcode = FDI_OP_COMP_NO_DATA;
        d.is_conf           = (op == FDI_OP_CFG_WR_32);
      end
...
//End side band FDI Packer//

  //start Side band FDI Controller//
